...
> **Arquivo histórico:** snapshot de uma entrega passada, preservado para rastreabilidade.
...
7. **[`scripts/archive/campaign-highlights/deploy_campaign_rotation.sh`](../../../../scripts/archive/campaign-highlights/deploy_campaign_rotation.sh)** — bloqueado e preservado
...
```bash
cd webgo
./scripts/archive/campaign-highlights/deploy_campaign_rotation.sh  # BLOQUEADO; referência histórica
```
