        ...
        <Popover open={isOpen} onOpenChange={(open) => {
          ...
          <PopoverTrigger asChild>
            ...
            >
              ...
              {rangeStartDate && rangeEndDate ? (
                <>
                  <span className="tabular">{format(rangeStartDate, "dd/MM/yyyy", { locale: ptBR })}</span>
                  {" até "}
                  <span className="tabular">{format(rangeEndDate, "dd/MM/yyyy", { locale: ptBR })}</span>
          ...
          <PopoverContent className="w-auto p-0" align="start">
            <div className="p-3 border-b">
              <span className="kicker">Selecionar período</span>
              <p className="text-xs text-muted-foreground mt-1.5">
                Clique em uma data para dia específico, ou selecione intervalo
              </p>
              {(tempCustomDate || (tempRangeStartDate && tempRangeEndDate)) && (
                <div className="mt-2 p-2 rounded-md border border-info/20 bg-info/10">
                  <p className="text-xs font-medium text-info flex items-center gap-1.5 tabular">
