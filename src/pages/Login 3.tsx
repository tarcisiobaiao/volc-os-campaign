  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary via-purple-600 to-blue-600 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full px-12 text-white">
          <div className="pt-12">
          ...
          {/* Simple Globe Test */}
          <div className="flex-1 flex items-center justify-center max-h-96">
            <SimpleGlobe />
          </div>
          ...
          <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button variant="outline" className="h-12 hover:bg-muted/50">
